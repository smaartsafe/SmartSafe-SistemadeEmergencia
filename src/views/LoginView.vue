<template>
    <div class="login-container">
      <div class="logo-container">
        <img src="../../public/images/FundoSplash.png" alt="Logo" class="logo" />
      </div>
      ...
      <form @submit.prevent="handleLogin" class="login-form">
        ...
        <div class="form-group">
          ...
          <input v-model="cityToken" id="token" type="text" placeholder="Digite o código" />
        </div>
  ...
  if (tokens[selectedCity.value] && cityToken.value === tokens[selectedCity.value]) {
    ...
    alert('Por favor, verifique se o token é correspondente para a cidade selecionada.');
  }
}
